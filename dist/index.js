...
var Threejs3DEarth = (function () {
  ...
  */
  ...
  var Threejs3DEarth = /*#__PURE__*/function () {
    function Threejs3DEarth(options) {
      _classCallCheck(this, Threejs3DEarth);
      this.el = options.el;
    ...
    _createClass(Threejs3DEarth, [{
      key: "initAxesHelper",
      value: function initAxesHelper() {
      ...
      value: function initObject() {
        //创建管道成型的路径(3D样条曲线)
        var path = new CatmullRomCurve3([new Vector3(-100, -50, -50), new Vector3(100, 50, 0), new Vector3(80, 50, 50), new Vector3(-50, 0, 100)]);

        // path:路径   40：沿着轨迹细分数  20：管道半径   25：管道截面圆细分数
        var geometry = new TubeGeometry(path, 40, 20, 25);
        //材质对象
        ...
        var points = [];
        points.push(new Vector3(-100, 50, 50));
        points.push(new Vector3(0, 100, 0));
        points.push(new Vector3(100, 0, 0));
        var geometry2 = new BufferGeometry().setFromPoints(points);
        var line2 = new Line(geometry2, material);
